...
PORTALS: tuple[dict[str, Any], ...] = (
    ...
    {"slug": "personio", "name": "Personio", "detects": False, "submits": UNPROVEN,
     "note": "XML feed exists but rate limits anonymous reads."},
    {"slug": "jazzhr", "name": "JazzHR", "detects": False, "submits": UNPROVEN},
    {"slug": "bamboohr", "name": "BambooHR", "detects": False, "submits": UNPROVEN,
     "note": "Careers list is server-rendered HTML, not an API."},
